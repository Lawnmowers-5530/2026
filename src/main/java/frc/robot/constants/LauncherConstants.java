...
public class LauncherConstants { //TODO: fill in constants
    ...
    public static final Translation3d blueTargetPose = new Translation3d(Units.inchesToMeters(60), Units.inchesToMeters(-60), Units.feetToMeters(6));//new Translation3d(4.619, 4.027, Units.feetToMeters(6));
    ...
    public static InterpolatingTreeMap<Double, Double> VelocityToRPS =
     ...
     static {
        ...
        VelocityToRPS.put(ProjectileAimer.findv0(Units.inchesToMeters(59.75), Rotation2d.fromDegrees(65), Units.inchesToMeters(15.5)), 20.0);
        VelocityToRPS.put(ProjectileAimer.findv0(Units.inchesToMeters(82), Rotation2d.fromDegrees(65), Units.inchesToMeters(15.5)), 25.0);
        VelocityToRPS.put(ProjectileAimer.findv0(Units.inchesToMeters(115), Rotation2d.fromDegrees(65), Units.inchesToMeters(15.5)), 30.0);
        VelocityToRPS.put(ProjectileAimer.findv0(Units.inchesToMeters(154.5), Rotation2d.fromDegrees(65), Units.inchesToMeters(15.5)), 35.0);
        VelocityToRPS.put(ProjectileAimer.findv0(Units.inchesToMeters(144+96), Rotation2d.fromDegrees(65), Units.inchesToMeters(15.5)), 40.0);
        VelocityToRPS.put(ProjectileAimer.findv0(Units.inchesToMeters(144+124), Rotation2d.fromDegrees(65), Units.inchesToMeters(15.5)), 45.0);
